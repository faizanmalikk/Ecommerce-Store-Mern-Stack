          ...
          <Box display='flex' flexDirection={{ xs: 'column', sm: 'row' }}>
            <Box flex='1'>
              <Box display='flex' flexDirection={'column'} alignItems='center' padding={'0 15px'} paddingTop={'15px'} paddingBottom='2.5em'>
                ...
                <Typography color='#9e9e9e' fontFamily={'Roboto'} fontWeight='bold' paddingTop='5px'>Faizan Malik</Typography>
                <Typography component={'a'} href='https://facebook.com' target={'_blank'} color='#9e9e9e' fontFamily={'Roboto'} paddingTop='10px'
                  sx={{ textDecoration: 'none', transition: 'all 0.4s ease', '&:hover': { cursor: 'pointer', color: '#616161' } }}
                >Visit Facebook
                </Typography>
                <Typography color='#bdbdbd' fontFamily={'Roboto'} textAlign='center'>This is a practice website made by &copy;faizanmalyk</Typography>
              </Box>
            </Box>
            <Box flex='1' borderTop={{ xs: '1px solid #e0e0e0', sm: 'none' }} borderLeft={{ sm: '1px solid #e0e0e0' }}>
              <Box display={'flex'} flexDirection='column' justifyContent='center' alignItems={'center'} paddingTop={'15px'}>
                <Typography color='#1976d2' fontFamily={'Roboto'} fontWeight='bold' fontSize={'35px'}>Our Brands</Typography>
